...
const ProductGrid = ({ productStyle, setProductStyle, products }) => {
  const options = [
    ...
    <>
      <div className="rounded-lg bg-white shadow-1 pl-3 pr-2.5 py-2.5 mb-6">
        <div className="flex items-center justify-between">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <p>
              Mostrando <span className="text-dark">{products.length} de {products.length}</span> Productos
            </p>
          </div>
          <div className="flex items-center gap-2.5">
            <button
              onClick={() => setProductStyle("grid")}
              aria-label="Botón para vista en cuadrícula"
              className={`${
      ...
      >
        {products.map((item, key) => (
          <ProductItems item={item} key={key} productStyle={productStyle} />
        ))}
      </div>
        ...
        <div className="bg-white shadow-1 rounded-md p-2">
          <ul className="flex items-center">
            <li>
              <button
                id="paginationLeft"
                aria-label="Botón para paginación izquierda"
                type="button"
                disabled
            ...
            <li>
              <button
                id="paginationRight"
                aria-label="Botón para paginación derecha"
                type="button"
